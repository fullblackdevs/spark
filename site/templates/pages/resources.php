		...
		<?php foreach ($resources as $resource) : ?>
			<div class="flex flex-col max-w-sm bg-white border border-gray-200 rounded-lg shadow">
				...
				<div class="grow flex flex-col p-5">
					...
					<a href="/partner/<?= $resource['partner']['slug'] ?>/resource/<?= $resource['slug'] ?>" class="w-fit inline-flex items-center px-3 py-2 text-sm font-medium text-center text-courageous-plum border-2 border-courageous-plum rounded-lg hover:bg-courageous-plum-300 hover:text-white focus:ring-4 focus:outline-none focus:ring-courageous-plum-400">
						Learn more

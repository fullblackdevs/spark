		...
		<?php foreach ($posts as $index => $post) : ?>
			<?php if (isset($post['format'])) : ?>
				...
				<?php elseif ($post['format'] === 'video') : ?>
					<div class="tracking-tight bg-white rounded-xl col-span-5 gap-0 items-stretch overflow-hidden p-6 relative <?php if (isset($post['media']['images']['featured'])) : ?>bg-[url('/assets/images/<?= $post['media']['images']['featured']['file'] ?>')] bg-cover<?php endif; ?>">

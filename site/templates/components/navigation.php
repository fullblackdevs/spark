...
<nav x-data="{ showMobileNav: false }" class="fixed top-0 flex justify-between grow w-screen md:h-full items-center md:relative">
	<h1 class="font-display text-7xl lg:text-9xl font-bold uppercase -mb-5 lg:-mb-8 -mt-2.5 lg:-mt-3 relative z-50"><a href="/">Spark</a></h1> <!-- need to work on these ratios -->
	...
	<ul class="absolute inset-0 md:static md:flex flex-col gap-4 md:flex-row md:grow md:justify-between lowercase font-body font-semibold text-3xl md:text-xl tracking-tight xl:mb-6 xl:me-12 w-dvw md:w-fit px-12 md:px-2 py-24 md:py-0 h-dvh md:h-full overflow-y-auto bg-courageous-plum/90 md:bg-transparent" :class="showMobileNav ? 'flex' : 'hidden'">
	...
	<div class="hidden md:flex items-center text-2xl gap-2 font-body font-semibold tracking-tight md:mx-4">
